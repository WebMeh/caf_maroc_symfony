...
{
    #[Route(name: 'admin_billets_list', methods: ['GET'])]
    ...
    #[Route('/new', name: 'admin_billet_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_billets_list', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'admin_billet_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'admin_billet_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'admin_billet_delete', methods: ['POST'])]
